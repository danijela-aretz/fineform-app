...
exports.mapToClientStatus = mapToClientStatus;
exports.getClientStatusInfo = getClientStatusInfo;
exports.getClientStatus = getClientStatus;
const client_1 = __importDefault(require("../db/client"));
/**
 * Map internal status to client-visible status
 */
function mapToClientStatus(internalStatus, engagementStatus, checklistCompleteAt, docConfirmationStatus, efileAuthorizationSigned) {
    ...
    if (internalStatus === 'READY_FOR_PREP' ||
 ...
 */
async function getClientStatus(entityTaxYearId) {
    ...
    const efileAuth = await client_1.default.efileAuthorization.findFirst({
        where: { entityTaxYearId },
    });
    const clientStatus = mapToClientStatus(entityTaxYear.internalStatus, entityTaxYear.engagementStatus, entityTaxYear.checklistCompleteAt, entityTaxYear.docConfirmationStatus, !!efileAuth);
